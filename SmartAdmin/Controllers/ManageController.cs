...
namespace SmartAdmin.Controllers
{
    ...
    public class ManageController : Controller
    {
          ...
          ILoggerFactory loggerFactory)
        {
            ...
            _userSettingService = usersettingServices;
            _userBusinessEntityService = userBusinessEntityService;
        ...
        {
            var data = _userSettingService.Query();
            if (!string.IsNullOrEmpty(search))
            {
                data.Where(a => a.FirstName.Contains(search) || a.LastName.Contains(search));
            }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, bool continueAdd, byte[] AvatarImage = null)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var userSetting = new UserSetting("", model.Name, "", "", null, user) { AvatarImage = AvatarImage, BusinessEntityId = businessEntityId, UserSettingId = user.Id };
                    _userSettingService.Add(userSetting);


                    var userBusinessEntity = new UserBusinessEntity() { BusinessEntityId = businessEntityId, UserSettingId = user.Id };
