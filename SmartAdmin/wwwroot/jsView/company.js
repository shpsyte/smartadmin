   ...
   MakeDropZone(e) {
    ...
    SaveContact(e) {
        $.ajax({
            dataType: "json",
            type: "POST",
            url: "/Company/PostContact",
            data: { id: $(e).attr("data-id"), name: $("#Name").val(), phone: $("#Phone").val(), email: $("#Email").val() },
            ...
            var table = document.getElementById("tblContatos");
            var row  = table.insertRow(1);
            var cell  = row.insertCell(0);
            var cell3 = row.insertCell(1);
            cell.innerHTML = response[0].msg;
            cell3.innerHTML = response[0].phone;
        });
    }
